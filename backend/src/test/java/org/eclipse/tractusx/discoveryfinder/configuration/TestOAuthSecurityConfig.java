...
public class TestOAuthSecurityConfig {
   ...
   @Bean
   public TestJwtTokenFactory jwtTokenFactory( DiscoveryFinderProperties discoveryFinderProperties ) {
      return new TestJwtTokenFactory( discoveryFinderProperties.getPublicClientId() );
   }
}
